...
| 网页端 | `web/`：城池、城墙、出征、战报、Canvas 大地图、邮件、排行、联盟、市集兑换与同盟运输；升级与征兵展示消耗 |
...
**当前第一版玩法已按第 0～10 步落地（含市集兑换与同盟运输），建造时长与田产出已按联调改过。** 开发环境会再缩短行军、保护罩和 AI tick。实机打一局后可按手感再调 Core 配置表。
