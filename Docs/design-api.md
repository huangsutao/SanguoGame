...
账号 / 建城见 [账号、角色与建城](design-account-city.md)；城内建筑见 [城内建筑](design-inner-city.md)；行军见 [行军战斗](design-march-battle.md)；PvP 见 [玩家对战](design-pvp.md)；邮件 / 排行 / 联盟见第 9 步文档。后续玩法继续用 `409xx` 细分。
