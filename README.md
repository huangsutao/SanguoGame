...
| 城墙 | 箭塔 / 城门 / 陷阱，与全城队列共用 |
| 军队 / 行军 | 征兵、出征 NPC / 玩家、到点结算、战报；常驻据点原地回血，流寇到期或被打掉消失 |
| AI 玩家 | 启动补齐 AI 城；Hangfire tick 升级 / 征兵 / 出征 |
| 网页端 | `web/`：登录入城场景、城内/城外/城墙/征兵/商城场景、每日军务、出征/侦察、战报、Canvas 大地图（地形昼夜与行军动效）、邮件、排行、联盟、市集兑换与同盟运输；Web Audio 音效；升级与征兵展示消耗 |
| 市集 / 运输 | 第 10 步：地图 NPC 市集按比例兑换；同联盟可运输资源，均按行军公式计时 |
| 分科科技 | 第 11 步：演武堂 / 城防署 / 司农院，升级即加成 |
| 每日军务 / 斥候 | 第 12 步：当天五条军务领犒赏；派斥候看据点 / 敌城 |
| 商城 / 元宝 / 道具 | 第 13 步：出征掉元宝；商城买加速、丰收、迁城令；征兵到点入帐 |
...
9. 邮件、排行、联盟
10. 市集兑换、同盟运输
11. 分科科技建筑（演武堂 / 城防署 / 司农院）
12. 每日军务与斥候侦察
13. 商城、元宝、限时道具与迁城

**当前第 0～13 步已落地。** 开发环境会再缩短行军、保护罩和 AI tick。实机打一局后可按手感再调 Core 配置表。
...
| 市集与运输 | [Docs/design-market.md](Docs/design-market.md) | 已定稿 |
| 分科科技 | [Docs/design-tech.md](Docs/design-tech.md) | 已定稿 |
| 每日军务与斥候 | [Docs/design-daily-scout.md](Docs/design-daily-scout.md) | 已定稿 |
| 商城、元宝与道具 | [Docs/design-shop.md](Docs/design-shop.md) | 已定稿 |
