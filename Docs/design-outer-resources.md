...
|------|------|------|------------|--------------|
| `farm` | 良田 | `grain` | 60 | 300 |
| `lumber` | 木场 | `wood` | 50 | 300 |
| `ironMine` | 铁矿 | `iron` | 40 | 300 |
| `copperMine` | 铜矿 | `copper` | 30 | 300 |

数值放 Core 配置表，可调。联调可把 `baseRatePerHour` 调大。
...
| type | 秒 | 粮 | 木 | 铁 | 铜 |
|------|----|----|----|----|----|
| farm | 25 | 150 | 80 | 20 | 10 |
| lumber | 25 | 80 | 150 | 20 | 10 |
| ironMine | 30 | 100 | 100 | 80 | 20 |
| copperMine | 30 | 100 | 80 | 40 | 80 |
